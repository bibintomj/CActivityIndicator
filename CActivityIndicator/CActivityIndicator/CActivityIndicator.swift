...
//    /// Spinning activity indicator
    ...
    /// Spinning activity indicator
//    private static let activityIndicator: NVActivityIndicatorView = {
//        let indicator = NVActivityIndicatorView(frame: CGRect(origin: .zero, size: CGSize(width: 50, height: 50)), type: .lineScale)
//        indicator.startAnimating()
//        return indicator
//    }()
    ...
    /// Calling this function will set counter to zero and hide the overlay.
